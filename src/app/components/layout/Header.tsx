...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#007466] text-white relative z-50">
      <div className="max-w-[1366px] mx-auto px-4 md:px-8 lg:px-16">
        <div className="flex items-center justify-between  py-3">
          {/* Logo */}
          <div className="">
            <Link href="/home">
              <Image src="/logo.svg" height={70} width={120} alt="site logo" />
            </Link>
          </div>
            ...
            <div className="ml-10 flex items-baseline space-x-4">
              {navItems.map((item) => (
                ...
                >
                  <Link
                    href={item.href || "#"}
                    className="flex items-center px-2 py-2 text-sm font-medium text-white hover:text-[#f25f4a] transition-colors duration-200 relative"
                  >
                    {item.label}
                    {item.dropdown && (
          ...
          <div className="lg:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-[#f25f4a] hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white transition-colors duration-200"
            >
