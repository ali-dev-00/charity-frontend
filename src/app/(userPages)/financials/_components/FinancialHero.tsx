                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_520px] gap-12 items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-sm tracking-wider  opacity-80 max-w-xl">
                                We’re committed to openness and integrity. Explore our audited financial reports to understand how every donation is used to create real, measurable impact in communities we serve.
                            </p>
                        ...
                        <div className="space-y-6 flex justify-end">
                            ...
                            <Image
                                src="/finance/financial-hero.svg"
